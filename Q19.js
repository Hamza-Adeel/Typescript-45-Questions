...
let newpersons2 = ["abdullah", "sana", "wali"];
...
console.log("Unfortunately guys I can invite only two persons for today's dinner ");
...
for (const i in relatives) {
    console.log(`${relatives[i]}, Hey you guys are still invited at my house for today's dinner`);
}
export {};
